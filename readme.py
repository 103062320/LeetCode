...
class Config:
    ...
    """
    local_path = 'E:\GitHub\LeetCode'
    github_leetcode_url = 'https://github.com/103062320/LeetCode/tree/master/code'
...
class TableInform:
    ...
    def __create_folder(self, folder):
        oj_algorithms = Config.local_path + '/' + folder
        if os.path.exists(oj_algorithms):
            print(folder, ' algorithms is already exits')
        else:
            print('creating {} algorithms....'.format(folder))
...
class Readme:
    ...
    def __init__(self, total, solved, locked, others=None):
        ...
        self.msg = '# A leetcode a day keeps unemployment away.\n' \
                   '## Statistic\n' \
                   'Solved **{}** / **{}** problems ' \
                   ...
                   '\n\nNote: :lock: means you need to buy a book from LeetCode\n'.format(
                    self.solved, self.total, self.locked, self.time, **self.others)
